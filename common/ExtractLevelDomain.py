...
if __name__ == "__main__":
    ...
    url = 'homepagestartup.com'
    print url
    print domain_parser.parse_url(url)
    print type(domain_parser.parse_url_level(url))
    print domain_parser.parse_url_level(url,level=2)
    print domain_parser.parse_url_level(url,level=1)
