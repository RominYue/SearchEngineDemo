...
if __name__ == '__main__':
    ...
    print u'search I love'
    for key, node in search(tree, u'I love', limit=10):
        print key, node.weight

    print '\nsearch I love you'
    for key, node in search(tree, u'I love you', limit=10):
        print key, node.weight

    print '\nsearch I love you all'
    for key, node in search(tree, u'I love you all', limit=10):
        print key, node.weight
